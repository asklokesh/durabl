...
### 3. How do I verify everything works?
...
### 4. Does durabl use process snapshots (CRIU)?
...
### 5. Can I replay runs with Restate stopped?
...
### 7. How does HITL pause/resume work?
...
### 8. Why can’t I submit HITL input from an offline export?
...
### 9. Can I switch model provider or deploy target without code changes?
...
### 10. Why do gates fail when I run two checkouts at once?
