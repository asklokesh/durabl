...
## Integration docs (`feat/integ-index`)

Merged on `feat/integ-index` from `main` (`c645a16`). Branch tip → merge commit on index:

| Branch | Branch tip | Merge commit on index |
|--------|------------|------------------------|
| `feat/integ-langsmith` | `4000dea` | `4000dea` (fast-forward) |
| `feat/integ-langchain` | `39d2b4b` | `cfb0337` |
| `feat/integ-langgraph` | `4bc4f60` | `7965dd6` |
| `feat/integ-openai-agents` | `0aa476c` | `c148d9c` |
| `feat/integ-mcp` | `57637f0` | `77a3b42` |
| `feat/integ-k8s` | `e6a9e76` | `53dab46` |
| `feat/integ-github-action` | `9f7e533` | `93ee25b` |
| `feat/integ-webhooks` | `a04e404` | `49d63b5` |

Index hub: [`INTEGRATIONS.md`](INTEGRATIONS.md), per-guide [`integrations/README.md`](integrations/README.md).
